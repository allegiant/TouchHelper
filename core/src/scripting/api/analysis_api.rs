...
use crate::domain::vision::analysis;
use crate::domain::vision::types::{Rect, SegmentationConfig, VisionError}; // 调用内部纯算法模块
...
/// 辅助函数：将 BGRA 数据原地转换为 RGBA
/// Kotlin 的 ByteBuffer 默认输出 BGRA (Little Endian ARGB)，
/// 我们在 Rust 端用极快的原生循环将其纠正。
